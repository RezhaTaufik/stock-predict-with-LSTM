...
def welcomeMessage():
  print('##############################################################################')
  print('####                                                                      ####')
  print('####   Prediksi Saham Menggunakan Long-Short Term Memory (LSTM)           ####')
  print('####                                                                      ####')
  print('####   Dikerjakan Oleh :                                                  ####')
  print('####        - T.M. Rezha Taufiqurrahman (201401019)                       ####')
  print('####        - Anggi Ester Herna (201401037)                               ####')
  print('####        - Chalil Al Vareel (201401043)                                ####')
  print('####        - Muhammad Teguh Sinulingga (201401057)                       ####')
  print('####        - Salsabila Humairah (201401065)                              ####')
  print('####                                                                      ####')
  print('##############################################################################')
  return
